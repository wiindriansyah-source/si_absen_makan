<div class="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
        <i class="fa-solid fa-user-graduate text-emerald-600"></i> Absensi Magang / PKL
    </h2>
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Nama Universitas/Sekolah</label>
